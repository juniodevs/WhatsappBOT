...
setTimeout(() => {
  ...
  voiceChannel.join()
  .then(connection => {
    connection.play("https://cdn.sndup.net/jgjg/whastsapp.ogg?token=_GrLhpzCBpxNq6KlH_ANnZ21FnQVjPa3aBFY7cijn_E&token_path=%2Fjgjg%2F&expires=1655060121", { volume: 1}).on("finish", () => {
